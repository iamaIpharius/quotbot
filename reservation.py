...
countrys_dict = {
    ...
    'USA main': ['usa_main', 'usa main'],
    'USA coop': ['usa_coop', 'usa coop'],
    'France': ['🇫🇷', 'fr', 'france', 'fronce', 'baguette', '🥖', '🐸', '🏳️', '🥐', '🧀'],
    'USSR': ['🇷🇺', 'sov', 'russia', 'soviet', 'ussr', 'stalin', 'gulag', 'vodka', '🐻', 'rus'],
    'USSR main': ['ussr_main', 'ussr main'],
    'USSR coop': ['ussr_coop', 'ussr coop'],
    ...
    'Germany main': ['germany_main', 'germany main'],
    'Germany coop': ['germany_coop', 'germany coop'],
    'Italy': ['🇮🇹', 'mama mia', 'ita', 'italy', 'spaghetti', 'pizza', 'avanti', 'italia', 'mussolini', '🍝', '🍕'],
    'Japan': ['🇯🇵', 'anime', 'jp', 'japan', 'sushi', 'emperor', 'hirohito', 'jap', 'nippon', '🍣', '👘'],
    'Japan main': ['japan_main', 'japan main'],
    'Japan coop': ['japan_coop', 'japan coop'],
